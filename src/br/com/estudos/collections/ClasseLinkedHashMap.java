...
public class ClasseLinkedHashMap {
	...
	public static void main(String[] args) {
       ...
       LinkedHashMap<Integer, Pessoa> pessoas = new LinkedHashMap<>();
		...
		System.out.println("Id do objeto juntamente com informações do objeto pessoa (Sempre mantém a ordem de inserção dos objetos)");
		...
		// Linked Hash Map não aceita ordenação
